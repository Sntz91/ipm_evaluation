from fivesafe.datasets.carla import VehicleDataset, bb_to_2d
...
import numpy as np
import cv2
from fivesafe.world_tracking import WorldSort


# I THINK ITS TIME TO REWRITE THE TRACKER 
# first) Such that working but encapsuled
# second) Such that its good.
...
# Then write a evaluation class where you put this stuff in and get a scalar. 
...
dataset = VehicleDataset(base_url='/home/ziegleto/ziegleto/data/5Safe/carla/circle/')

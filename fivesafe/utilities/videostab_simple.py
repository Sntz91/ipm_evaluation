...
def imgstab_ai(filelist, outputpath_imgs_stab):
    ...
    extractor = DISK(max_num_keypoints=2048).eval().cuda()  # load the extractor, set resize to 2048
    matcher = LightGlue(features='disk').eval().cuda() # load the matcher

    image0 = load_image(filelist[0]).cuda()
...
if __name__ == '__main__':
    basepath = "/home/ziegleto/ziegleto/data/5Safe/peter_paul/petpa/camera_top/"
    vidname = "1"
